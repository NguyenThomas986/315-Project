...
The report should focus on one of the following two topics: 

      (a). Data Mining Tasks: Apply data mining approaches to one or multiple real-world datasets. (A file containing some project ideas will be uploaded soon)
...
- State your personal motivation for selecting this particular project and what were your goals.
